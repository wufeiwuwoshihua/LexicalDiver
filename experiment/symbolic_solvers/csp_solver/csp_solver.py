    ...
    def execute_program(self, debug_mode = False):
        ...
        for variable in self.Variables:
            try:
                ...
                return None, f"Invalid variable definition: {variable}"
        ...
        for rule in self.Constraints:
            ...
            try:
                ...
                return None, f"Constraint parsing error: {e}"

        # 解决问题
        python_program_list.append('ans = problem.getSolutions()')
...
"""
    ...
    ans, err_message = csp_program.execute_program()
    print(ans)
