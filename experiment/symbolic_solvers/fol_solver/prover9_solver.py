...
os.environ['PROVER9'] = './pre_experiment/symbolic_solvers/prover9_windows/bin'
...
class FOL_Prover9_Program:
    ...
    def parse_logic_program(self):
        try:        
            ...
            premises_string = self.logic_program.split("Question:")[0].split("Premises:")[1].strip()
            conclusion_string = self.logic_program.split("Question:")[1].strip()
...
if __name__ == "__main__":
    ...
    prover9_program = FOL_Prover9_Program(logic_program8)
